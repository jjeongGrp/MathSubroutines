...
#  Input:
#
#    integer S1, S2, S3, three values used as the
...
#
#    integer S1, S2, S3, updated seed values.
#
  s1 = ( ( 171 * s1 ) % 30269 )
  s2 = ( ( 172 * s2 ) % 30307 )
  s3 = ( ( 170 * s3 ) % 30323 )
...
#  Input:
#
#    integer S1, S2, two values used as the
...
#  Output:
#
#    real VALUE, the next value in the sequence.
#
#    integer S1, S2, updated seed values.
#
  k = s1 / 53668
