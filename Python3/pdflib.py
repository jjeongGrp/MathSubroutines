...
#
  ...
  for i in range ( 0, 10 ):
    n = np.random.random_integers ( 1, 20 )
    p = np.random.rand ( )
...
#
  ...
  for k in range ( 0, 10 ):
    m = np.random.random_integers ( 2, 10 )
    n = np.random.random_integers ( 1, 5 )
    p = np.random.rand ( m )
    ptot = np.sum ( p )
    p = p / ptot
...
#  Input:
#
#    real ALPHA, BETA, shape parameters.
#    0.0 < ALPHA, BETA.
#
...
#
  ...
  for i in range ( 0, 10 ):
    alpha = 5.0 * np.random.rand ( )
    beta = 5.0 * np.random.rand ( )
...
#
  ...
  for i in range ( 0, 10 ):
    ...
    a = -100.0 + 200.0 * np.random.rand ( )
    b = -100.0 + 200.0 * np.random.rand ( )
    t = max ( a, b )
    a = min ( a, b )
    b = t
