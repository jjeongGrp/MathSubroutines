...
def animation_test ( xi = 0.015, nu = 1.0 ):

#*****************************************************************************80
#
## animation_test() displays successive solutions of the Allen-Cahn equation.
#
#  Discussion:
#
#    This version of the equation has the form:
...
#
  ...
  print ( '  Display each solution to the screen.' )
