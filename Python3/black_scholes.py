...
#  Input:
#
#    real S0, the asset price at time 0.
#
#    real MU, the expected growth rate.
#
#    real SIGMA, the volatility of the asset.
#
#    real T1, the expiry date.
#
#    integer N, the number of steps to take between 0 and T1.
#
#  Output:
#
#    real S(N+1), the option values from time 0 to T1 in equal steps.
#
  import numpy as np
...
#
  ...
  print ( '  asset_path() simulates an asset price path.' )
...
#    real S0, the asset price at time 0.
#
#    real E, the exercise price.
#
#    real R, the interest rate.
#
#    real SIGMA, the volatility of the asset.
#
#    real T1, the expiry date.
#
#    integer M, the number of steps to take between 0 and T1.
#
#  Output:
#
#    real C, the option value at time 0.
#
  import numpy as np
...
#
  print ( '' )
  print ( 'binomial_test():' )
  print ( '  binomial() uses the binomial method for option valuation.' )
...
#  Input:
#
#    real S0, the asset price at time T0.
#
#    real T0, the time at which the asset price is known.
#
#    real E, the exercise price.
#
#    real R, the interest rate.
...
#  Output:
#
#    real C, the value of the call option.
#
  import numpy as np
...
#
  print ( '' )
  print ( 'bsf_test():' )
  print ( '  bsf() uses the Black-Scholes formula for option valuation.' )
...
#    real T1, the expiry date.
#
#    integer NX, the number of "space" steps used to divide the 
#    interval [0,L].
#
#    integer NT, the number of time steps.
#
#    real SMAX, the maximum value of S to consider.
#
#  Output:
#
#    real U(NX-1,NT+1), the value of the European call option.
#
  import numpy as np
...
#
  ...
  print ( '' )
  print ( 'forward_test():' )
  print ( '  forward() uses the forward difference method for option valuation.' )
...
#  Output:
#
#    real CONF[2], the estimated range of the valuation.
#
  import numpy as np
...
#
  print ( '' )
  print ( 'mc_test():' )
  print ( '  mc() uses the Monte Carlo method for option valuation.' )
