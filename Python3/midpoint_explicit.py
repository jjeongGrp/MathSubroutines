...
#*****************************************************************************80
#
## midpoint_explicit_humps_test solves humps ODE using explicit midpoint method.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the humps ODE system using midpoint_explicit().' )
...
#*****************************************************************************80
#
## midpoint_explicit_predator_prey_test: predator prey using explicit midpoint.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the predator prey ODE system using midpoint_explicit().' )
