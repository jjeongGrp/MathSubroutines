...
#
  ...
  for test in range ( 0, 10 ):
    ...
    i = np.random.random_integers ( 0, 6 )
    ti = t_polynomial_value ( i, x )
    j = np.random.random_integers ( -1, 4 )
...
#
  ...
  for test in range ( 0, test_num ):
    i = np.random.random_integers ( 2, 6 )
    j = np.random.random_integers ( 1, 3 )
    k = np.random.random_integers ( 0, 4 )
