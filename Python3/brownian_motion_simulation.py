...
#
#    real T, the total time.
#
#    real DSQ(K,N), the displacements over time for each repetition.
#
...
#    This might be 1001.
#
#    integer M, the spatial dimension.  Typically, this is 2.
#
#    real D, the diffusion coefficient.  This might be 10.0.
#    Computationally, this is simply a scale factor between time and space.
#
#    real T, the total time, which defaults to 1.0.
#
#  Output:
#
#    real DSQ(K,N), the displacements over time for each repetition.
...
#    integer N, the number of time steps. 
#
#    real X(M,N), the particle positions.
#
  import matplotlib.pyplot as plt
  import numpy as np
...
#   plt.axis ( 'equal' )
    ...
    raise Exception ( 'brownian_motion_display - Fatal error!' )
...
#  Output:
#
#    real X(M,N), the initial position at time 0.0, and 
...
#
  ...
  print ( '  Test brownian_motion_simulation().' )
#
