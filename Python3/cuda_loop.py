...
#  Input:
#
#    integer BLOCKS[3], the CUDA block values.  These should be nonnegative.
#    Typically, the third entry is 1.  Generally, the first two values cannot
#    be greater than 35,535.
#
#    integer THREADS[3], the CUDA thread values.  These should be nonnegative.
...
#
  ...
  print ( "  cuda_loop() simulates the way CUDA breaks up an iterative task, using" )
