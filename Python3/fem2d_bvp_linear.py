#! /usr/bin/env python3
#
def fem2d_bvp_linear_test ( ):

#*****************************************************************************80
#
## fem2d_bvp_linear_test() solves a 2D boundary value problem in the unit square.
#
#  Discussion:
#
...
#
#    integer LINEAR_ELEMENT_NUM, the number of elements 
#    in a row in the X or Y dimension.
#
#    integer NODE_LINEAR_NUM, the number of nodes in the X or Y dimension.
#
