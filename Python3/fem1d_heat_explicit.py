...
#  Output:
#
#    sparse real C(NODE_NUM,NODE_NUM), the finite element mass matrix.
#
#  Local:
#
#    real BI, DBIDX, the value of some basis function
...
#
#    real POINT_X, the evaluation points.
#
#  Output:
#
#    real B, DBDX, the basis function and its derivative, evaluated
...
#    integer X_NUM, the number of nodes.
#
#    real K(X_NUM), the heat conductivity coefficient.
#
#    real NODE_X(X_NUM), the coordinates of the nodes.
#
...
#
  ...
  if ( 0.5 <= cfl ):
    ...
    raise Exception ( 'fem1d_heat_explicit_cfl - Fatal error!' )
...
#
#    real X(X_NUM), the coordinates of the nodes.
#
#    real T, the current time.
#
...
#
#    sparse real MASS(NODE_NUM,NODE_NUM), the mass matrix.
#
#    real U(X_NUM), the solution at time T.
#
#  Output:
#
#    real U_NEW(X_NUM), the solution at time T + dT.
#
  import numpy as np
#
...
#  Output:
#
#    real U(X_NUM), the solution at time T, with
...
#  Output:
#
#    real U(X_NUM), the initial value of U.
#
  import numpy as np
...
#    integer X_NUM, the number of evaluation points.
#
#    real X(X_NUM), the evaluation points.
#
#    real T, the time.
#
#  Output:
#
#    real rhs_VALUE(X_NUM), the right hand side function at
...
#  Output:
#
#    real k_VALUE(X_NUM), the value of K(X,T).
#
  import numpy as np
...
#  Output:
#
#    real rhs_VALUE(X_NUM), the source term.
#
  import numpy as np
...
#*****************************************************************************80
#
## fem1d_heat_explicit_test() tests fem1d_heat_explicit().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  Test fem1d_heat_explicit().' )
...
#
  ...
  if ( quad_num == 1 ):
    ...
    raise Exception ( 'quadrature_set - Fatal error!' )
