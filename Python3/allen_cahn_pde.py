...
#*****************************************************************************80
#
## allen_cahn_deriv() returns the right hand side of the allen-cahn PDE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## allen_cahn_initial_condition(): initial condition for the Allen-Cahn PDE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
def allen_cahn_pde_euler_display ( xi = 0.015, nu = 1.0 ):

#*****************************************************************************80
#
## allen_cahn_pde_euler_display() solves the Allen-Cahn PDE using Euler. 
#
#  Discussion:
#
...
#
  ...
  print ( '' )
  print ( 'allen_cahn_pde_euler_display():' )
  print ( '  Use the Euler method to solve the' )
  print ( '  Allen-Cahn 1D reaction-diffusion PDE.' )
...
#
  ...
  ax.set_ylim ( -1.1, +1.1 )
  plt.grid ( True )
  plt.title ( 'Allen-Cahn PDE, xi = %g, nu =%g' % ( xi, nu ) )
...
def allen_cahn_pde_euler_movie ( xi = 0.015, nu = 1.0 ):

#*****************************************************************************80
#
## allen_cahn_pde_euler_movie() solves the Allen-Cahn PDE using Euler. 
#
#  Discussion:
#
...
#
  ...
  print ( '' )
  print ( 'allen_cahn_pde_euler_movie()' )
  print ( '  Use the Euler method to solve the' )
  print ( '  Allen-Cahn 1D reaction-diffusion PDE.' )
  print ( '  Interface thickness xi = %g' % ( xi ) )
  print ( '  Diffusion coefficient nu = %g' % ( nu ) )
...
#
  ...
  filename = 'allen_cahn_pde_euler_movie.mp4'
...
def allen_cahn_pde_test ( ):

#*****************************************************************************80
#
## allen_cahn_pde_test() tests allen_cahn_pde().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '' )
  print ( 'allen_cahn_pde_test():' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  Solve the Allen-Cahn PDE using the method of lines' )
  print ( '  and various ODE solvers.\n' )
