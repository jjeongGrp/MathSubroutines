...
#
  ...
  if ( rule < 1 or 10 < rule ):
    ...
    raise Exception ( 'A_LOG - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    raise Exception ( 'A_POWER - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'A_REGULAR - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 10 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 10.' )
    raise Exception ( 'j_log - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'j_power - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'j_regular - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 10 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 10.' )
    raise Exception ( 'order_log - Fatal error!' )
...
#  Output:
#
#    real ORDER, the order of the rule.
#
  import numpy as np
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'order_power - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'order_regular - Fatal error!' )
...
#  Output:
#
#    real X[J], W[J], the points and weights needed for the rule.
#
  import numpy as np
  ...
  if ( rule < 1 or 10 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 10.' )
    raise Exception ( 'rule_log - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'rule_power - Fatal error!' )
...
#
  ...
  if ( rule < 1 or 12 < rule ):
    ...
    print ( '  Input value of RULE is not between 1 and 12.' )
    raise Exception ( 'rule_regular - Fatal error!' )
...
#  Output:
#
#    real VALUE, the integral of the test integrand from 0 to 1.
#
...
#  Output:
#
#    real F(N), the integrand at the evaluation points.
#
  import numpy as np
