...
#    0.0 < X.
#
#    real MU, SIGMA, the parameters of the log normal PDF.
#    0.0 < SIGMA.
#
...
#
  ...
  if ( not check ):
    ...
    raise Exception ( 'log_normal_truncated_ab_cdf - Fatal error!' )
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_cdf_inv - Fatal error!' )
...
#
  ...
  if ( not check ):
    ...
    print ( '  The parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_cdf_test - Fatal error!' )
  ...
  for i in range ( 0, 10 ):
    ...
    x = log_normal_truncated_ab_sample ( mu, sigma, a, b )
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_mean - Fatal error!' )
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_pdf - Fatal error!' )
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_sample - Fatal error!' )

  lncdf_a = log_normal_cdf ( a, mu, sigma )
  lncdf_b = log_normal_cdf ( b, mu, sigma )

  cdf = lncdf_a + ( lncdf_b - lncdf_a ) * np.random.rand ( )
...
#
  ...
  if ( not check ):
    ...
    print ( '  The parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_sample_test - Fatal error!' )
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameters are not legal.' )
    raise Exception ( 'log_normal_truncated_ab_variance - Fatal error!' )
...
#*****************************************************************************80
#
## log_normal_truncated_ab_test() tests log_normal_truncated_ab().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license. 
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  Test log_normal_truncated_ab().' )
...
#*****************************************************************************80
#
## normal_01_sample_test() tests normal_01_mean(), normal_01__sample(), normal_01_variance().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  if ( not check ):
    ...
    print ( '  The parameters are not legal.' )
    raise Exception ( 'normal_sample_test - Fatal error!' )
