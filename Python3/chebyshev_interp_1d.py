...
#
#    real XD(ND), the data locations.
#
#    real YD(ND), the data values.
#
#  Output:
#
#    real C(ND), the Chebyshev coefficients.
#
#    real XMIN, XMAX, the interpolation interval.
#
  import numpy as np
...
#
#    real XI(NI), the interpolation points, which
...
#
  ...
  print ( '  Test chebyshev_interp_1d().' )
