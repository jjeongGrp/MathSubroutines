...
#
  ...
  print ( '  Test midpoint_fixed method for solving an ordinary differential equation.' )
...
#*****************************************************************************80
#
## midpoint_fixed_humps_test() solves the humps ODE using midpoint_fixed.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the humps ODE system using midpoint_fixed().' )
  ...
  plt.xlabel ( '<--- T --->' )
  plt.ylabel ( '<--- Y(T) --->' )
  plt.title ( 'humps ODE solved by midpoint_fixed()' )
...
#*****************************************************************************80
#
## midpoint_fixed_predator_prey_test() solves predator prey ODE using midpoint_fixed.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
