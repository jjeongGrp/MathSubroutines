...
#  Input:
#
#    real value = FN ( X ), the name of the MATLAB function which 
#    evaluates the function to be minimized, preceded by an "@" sign.
#
#    integer N, the number of variables.
#
#    real START(N).  On a starting point
#    for the iteration.  On this data may have been overwritten.
#
...
#*****************************************************************************80
#
## nelmin_helical_test() tests nelmin() on the HELICAL function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Test nelmin() on the HELICAL function.' )
...
#*****************************************************************************80
#
## nelmin_powell_test() tests nelmin() on the POWELL function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Test nelmin() on the POWELL quartic function.' )
...
#*****************************************************************************80
#
## nelmin_quartic_test() tests nelmin() on the QUARTIC function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Test nelmin() on the QUARTIC function.' )
...
#*****************************************************************************80
#
## nelmin_rosenbrock_test() tests nelmin() on the ROSENBROCK function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Test nelmin() on the ROSENBROCK function.' )
