...
#  Input:
#
#    integer NS(3), the number of intervals along each dimension.
#
#  Output:
#
...
#  Input:
#
#    real XV[8,3], the vertices of the hexahedron, in a particular order.
#
#    integer NG, the number of grid points.
#
...
#*****************************************************************************80
#
## cube_grid_display_test() tests cube_grid_display().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#  Input:
#
#    integer NS[3], the number of points along each dimension.
#
#    real XV[8,3], the vertices, in the order
#
