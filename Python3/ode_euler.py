...
#*****************************************************************************80
#
## ode_euler_test tests ode_euler().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '' )
  print ( 'ode_euler_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  Test ode_euler()' )
...
#*****************************************************************************80
#
## ode_euler_humps uses the Euler method to solve the HUMPS ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
